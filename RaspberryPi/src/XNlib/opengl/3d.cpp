...
/*
    comple:
        g++ ./glad/src/glad.c 3d.cpp -I./glad/include -lglfw3 -lGL -lX11 -lpthread -lXrandr -lXi -ldl -lXxf86vm -o 3d
...
int main()
{
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(xn::gl::cube_verts), xn::gl::cube_verts, GL_STATIC_DRAW);
