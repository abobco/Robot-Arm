/*
    comple:
        g++ ./glad/src/glad.c glfw_win.cpp -I/home/abobco/RaspberryPi/glad/include -lglfw3 -lGL -lX11 -lpthread -lXrandr -lXi -ldl -lXxf86vm -o window
...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "VIRTUA ARM 3", NULL, NULL);
    if (window == NULL)
    {
