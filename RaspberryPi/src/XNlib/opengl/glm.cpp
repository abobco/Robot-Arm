...
/*
    comple:
        g++ ./glad/src/glad.c glm.cpp -I/home/abobco/RaspberryPi/glad/include -lglfw3 -lGL -lX11 -lpthread -lXrandr -lXi -ldl -lXxf86vm -lglm -o 3d
...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "boxes", NULL, NULL);
    if (window == NULL)
    {
